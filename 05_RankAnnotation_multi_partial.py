...
ValidationOut_Summary_Filename = '08_Thread{0}_ValidationOutput_Summary_filtered.csv'.format(THREAD_NUMBER)
validOut_Summary_df.to_csv(os.path.join(SAVE_FOLDER,ValidationOut_Summary_Filename),index=False)
...
AnnotationRankInput_Filename = '09_Thread{0}_AnnotaionRankInput_notFiltered.csv'.format(THREAD_NUMBER)
