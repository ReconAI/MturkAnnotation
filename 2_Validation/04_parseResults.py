...
df = pd.read_csv('results/04_ValidationOutputMerged.csv') #Batch_3998716_batch_results.csv
...
while(True):
    ...
    v_annotation = v_row['image_annotation']
    ...
    cv2.putText(v_image,str(v_decision), (300,h), cv2.FONT_HERSHEY_SIMPLEX, 1,(255, 255, 255),1)
...
cv2.destroyAllWindows()
#df.to_csv('r/Batch_3998716_batch_results_reviewed.csv')
